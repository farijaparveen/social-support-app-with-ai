...
import { AiSuggestionModalComponent, ModalState } from '../ai-suggestion-modal/ai-suggestion-modal.component';
...
export class Step3SituationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form = this.fb.group({
      financialSituation: [saved.financialSituation || '', [Validators.required, Validators.minLength(30)]],
      employmentCircumstances: [saved.employmentCircumstances || '', [Validators.required, Validators.minLength(30)]],
      reasonForApplying: [saved.reasonForApplying || '', [Validators.required, Validators.minLength(30)]]
    });
  }
